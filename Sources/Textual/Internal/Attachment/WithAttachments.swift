...
struct WithAttachments17<Content: View>: View {
...
struct WithAttachments16<Content: View>: View {
  @Environment(\.imageAttachmentLoader) private var imageAttachmentLoader
  @Environment(\.emojiAttachmentLoader) private var emojiAttachmentLoader
  @Environment(\.colorEnvironment) private var colorEnvironment

  @StateObject private var model = WithAttachmentsModel16()
...
@MainActor final class WithAttachmentsModel16: ObservableObject {
